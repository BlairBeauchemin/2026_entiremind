...
- **Database migration**: `supabase/migrations/018_quotes_and_weekly_editions.sql`
...
**Manual setup:** create the AC list, verify the sending domain (DKIM) in AC, set env vars in Vercel. Run migration 018 + the import script before the first Monday draft.
