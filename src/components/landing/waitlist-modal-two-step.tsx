              ...
              <div className="flex justify-center gap-2 mb-6">
                <div
                  className={`w-2 h-2 rounded-full transition-colors ${
                    step >= 1 ? "bg-cobalt" : "bg-rule"
                  }`}
                />
                <div
                  className={`w-2 h-2 rounded-full transition-colors ${
                    step >= 2 ? "bg-cobalt" : "bg-rule"
                  }`}
                />
              </div>
                ...
                {step === 1 ? (
                  ...
                  >
                    ...
                    <form onSubmit={handleStep1Submit} className="space-y-4">
                      ...
                      <button
                        type="submit"
                        className="w-full bg-cobalt text-linen py-3.5 rounded-sm font-medium hover:bg-cobalt-deep transition-all duration-300 font-sans"
                      >
                        Continue
                      </button>
                    </form>
                  ...
                  >
                    ...
                    <form onSubmit={handleStep2Submit}>
                      ...
                      <button
                        ...
                        className="w-full bg-cobalt text-linen py-3.5 rounded-sm font-medium hover:bg-cobalt-deep transition-all duration-300 font-sans disabled:opacity-50 mt-6"
                      >
                      ...
                      <button
                        type="button"
                        onClick={() => setStep(1)}
                        className="w-full text-sm text-muted hover:text-cobalt transition-colors mt-3"
                      >
                        Back
                      </button>
                    </form>
