...
export function ShareArchetypeButton({
  ...
  return (
    <button
      type="button"
      onClick={handleShare}
      className="inline-flex items-center gap-2 rounded-full border border-cobalt bg-surface px-4 py-2 text-sm font-medium text-ink transition-colors hover:border-cobalt"
    >
      {copied ? (
        <>
